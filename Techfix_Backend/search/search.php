...
<body>
    ...
    <form class="reg" action="" method="post" onsubmit="return false">
        ...
        <div class = "card">
            ...
            <h6>WORKING DAYS:</h6>
            <p>sat-sun</p>
            <h6 id="cat2">CATEGORY:</h6>
            <h6 id="rating2" style="display: none; color: white;">Rating from 1 to 5 :</h6>
            <p id="catword2">computer ad donya</p>
            <input type="text" class="form-control" id= "ratingword2" style="display: none;max-width: 200px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <h6 id="address2">Address:</h6>
            <h6 id="comment2" style="display: none; color: white;">Comment :</h6>
            <p id="addressword2">kol 7ta w kol makan</p>
            <input type="text" class="form-control" id= "commentword2" style="display: none;max-width: 500px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <button type="submit" class="btn feedbtn" onclick="feed2();" id="feed2btn">Give Feedback</button>
        </div>
        ...
        <div class = "card">
            ...
            <h6>WORKING DAYS:</h6>
            <p>sat-sun</p>
            <h6 id="cat3">CATEGORY:</h6>
            <h6 id="rating3" style="display: none; color: white;">Rating from 1 to 5 :</h6>
            <p id="catword3">computer ad donya</p>
            <input type="text" class="form-control" id= "ratingword3" style="display: none;max-width: 200px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <h6 id="address3">Address:</h6>
            <h6 id="comment3" style="display: none; color: white;">Comment :</h6>
            <p id="addressword3">kol 7ta w kol makan</p>
            <input type="text" class="form-control" id= "commentword3" style="display: none;max-width: 500px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <button type="submit" class="btn feedbtn" onclick="feed3();" id="feed3btn">Give Feedback</button>
        </div>
        ...
        <div class = "card">
            ...
            <h6>WORKING DAYS:</h6>
            <p>sat-sun</p>
            <h6 id="cat4">CATEGORY:</h6>
            <h6 id="rating4" style="display: none; color: white;">Rating from 1 to 5 :</h6>
            <p id="catword4">computer ad donya</p>
            <input type="text" class="form-control" id= "ratingword4" style="display: none;max-width: 200px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <h6 id="address4">Address:</h6>
            <h6 id="comment4" style="display: none; color: white;">Comment :</h6>
            <p id="addressword4">kol 7ta w kol makan</p>
            <input type="text" class="form-control" id= "commentword4" style="display: none;max-width: 500px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <button type="submit" class="btn feedbtn" onclick="feed4();" id="feed4btn">Give Feedback</button>
        </div>
        ...
        <div class = "card">
            ...
            <h6>WORKING DAYS:</h6>
            <p>sat-sun</p>
            <h6 id="cat5">CATEGORY:</h6>
            <h6 id="rating5" style="display: none; color: white;">Rating from 1 to 5 :</h6>
            <p id="catword5">computer ad donya</p>
            <input type="text" class="form-control" id= "ratingword5" style="display: none;max-width: 200px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <h6 id="address5">Address:</h6>
            <h6 id="comment5" style="display: none; color: white;">Comment :</h6>
            <p id="addressword5">kol 7ta w kol makan</p>
            <input type="text" class="form-control" id= "commentword5" style="display: none;max-width: 500px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <button type="submit" class="btn feedbtn" onclick="feed5();" id="feed5btn">Give Feedback</button>
        </div>
        ...
        <div class = "card">
            ...
            <h6>WORKING DAYS:</h6>
            <p>sat-sun</p>
            <h6 id="cat6">CATEGORY:</h6>
            <h6 id="rating6" style="display: none; color: white;">Rating from 1 to 5 :</h6>
            <p id="catword6">computer ad donya</p>
            <input type="text" class="form-control" id= "ratingword6" style="display: none;max-width: 200px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <h6 id="address6">Address:</h6>
            <h6 id="comment6" style="display: none; color: white;">Comment :</h6>
            <p id="addressword6">kol 7ta w kol makan</p>
            <input type="text" class="form-control" id= "commentword6" style="display: none;max-width: 500px;max-height: 30px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
            <button type="submit" class="btn feedbtn" onclick="feed6();" id="feed6btn">Give Feedback</button>
        </div>
    </body>
