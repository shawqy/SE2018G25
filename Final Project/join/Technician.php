<?php
 $dsn='mysql:host=fdb25.awardspace.net;dbname=2964376_techfix';
           try{

         $connection=new PDO($dsn,'2964376_techfix','1500772shawqy');
...
$stml->execute();
 echo "We will contact You within 24 hrs" . "<br>";   
}
