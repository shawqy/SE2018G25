      ...
      <script type="text/javascript">
          ...
          function edit2(){
                if(document.getElementById("job1word").style.display=="none")
                    {
                        document.getElementById("editbtn1").innerHTML="Edit Info";
                        ...
                        document.getElementById("editbtn1").innerHTML="Save Edits";
...
<!-- ============================================= Button to Sign Out and go back to Homepage ================================================ -->
            <div class="col-md-1" style="float: right;">
                <form action="TechProfile.php" method="POST">
                    <button type="submit" onclick="e"  class="btn btn" id="sign" style="float:inherit; margin-right: 45px;margin-top: 160px; background-color: rgba(197, 197, 197, 0.62);font-family:'metropolis-regular',sans-serif;text-transform: uppercase;font-size: 0.8rem;padding: 10px 25px;border:0rem solid #c5c5c5;border-radius: 3px;letter-spacing: 0.15rem;color: #123e64;font-weight:bold;" name="logout">Sign Out</button>
               </form>      
            </div>
            </li>
        </ul>
...
<!-- ============================================= Category change to be sent to the database =============================================== -->
              <select class="form-control" id= "catedit" style="display: none;max-width: 500px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
...
<!-- ============================================= Working hours Retrived from the database =============================================== -->
              <h4 style="display: block; color: white;" id="hrsword" style="color: white;">9 am - 2 pm</h4>
              <h4 style="display: none;color: white;" id="hrssub">Working hours : </h4>
<!-- ============================================= Working hours change to be sent to the database =========================================== -->
              <input type="text" class="form-control"  id= "hrsedit" style="display: none; max-width: 500px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif; ">
<!-- ============================================= Working days Retrived from the database =============================================== -->
              <h4 style="display: block; color: white;" id="daysword" style="color: white;">Sun-Mon-Tues-Wed-Thurs</h4>
              <h4 style="display: none;color: white;" id="dayssub">Working days : </h4>
<!-- ============================================= Working days change to be sent to the database =========================================== -->
              <input type="text" class="form-control"  id= "daysedit" style="display: none; max-width: 500px;margin-bottom: 10px;font-family:'metropolis-semibold',sans-serif;">
<!-- ===================================================== Age retrived from the database  =================================================== -->
              <h4 style="display: block; color: white;" id="rating">Age : 27</h4>
<!-- ============================================= Overall Rating retrived from the database  =============================================== -->

              <h4 style="display: block; color: white;" id="rating">Rating: 4.1 /5.0</h4>
          </div>
...
<!-- ============================================= Button to submit changes and send them to database  ====================================== -->
            <div class="col-md-1" style="float: right;">
                    <button type="submit" onclick="edit2();" id="editbtn1" class="btn btn btn-success" style="float: right; margin-left: 200px; margin-bottom: 500px; background-color: cornflowerblue; display: inline-block;">Edit Info</button>      
            </div>
          <h2 class="mb-5">Experience</h2>
            
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
<!-- ============================================= Experience 1 Title retrived from database  ====================================== -->
              <h3 class="mb-0" style="display: block;" id="job1word">Building plumbing system</h3>
              <h4 style="display: none;" id="job1sub">Job : </h4>
<!-- ============================================= Experience 1 Title change to be sent to database  ====================================== -->
             <input type="text" class="form-control" id= "job1edit" style="display: none;max-width: 500px;margin-bottom: 20px ">
<!-- ============================================= Experience 1 Description retrived from database  =================================== -->
...
<!-- ============================================= Experience 1 Description change to be sent to database  =================================== -->
...
<!-- ============================================= Experience 2 Description change to be sent to database  =================================== -->
...
<!-- ============================================= Experience 3 Description change to be sent to database  =================================== -->
